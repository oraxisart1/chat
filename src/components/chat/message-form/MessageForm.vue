<template>
  ...
  <q-file v-model="messageFiles" ref="filePicker" v-show="false" multiple></q-file>

  <MessageFiles v-model="isMessageFiles"></MessageFiles>
</template>
...
import MessageFiles from 'components/chat/message-files/MessageFiles';

const store = useChatStore();
const {messageText, replyingMessage, editingMessage, isMessageFiles, messageFiles} = storeToRefs(store);
const {sendMessage, stopReplyingMessage, stopEditingMessage} = store;
